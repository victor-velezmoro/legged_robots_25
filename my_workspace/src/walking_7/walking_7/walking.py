...
from walking_7.talos import Talos
...
from walking_7.foot_trajectory_timo import SwingFootTrajectory
from walking_7.footstep_planer_timo import FootStepPlanner
from walking_7.footstep_planer_timo import Side
...
def main(args=None):
    ...
    x0 = np.array([
        T_support_w.translation[0],  # x
        0.0,                          # x_dot
        T_support_w.translation[1],  # y
        0.0,                          # y_dot                         # z
    ])
    ...
    com_rf = np.array([T_support_w.translation[0], T_support_w.translation[1], conf.h])
